...
$msi = Join-Path $projectRoot "src-tauri/target/release/bundle/msi/MyRay Lite_${expectedVersion}_x64_zh-CN.msi"
...
$view.Close()
foreach ($required in @('myray-lite-tauri.exe','xray.exe','sing-box.exe','libcronet.dll','geoip.dat','geosite.dat')) {
