...
pub struct Settings {
    ...
    pub tun_ipv6: bool,
    pub tun_bypass_lan: bool,
    pub tun_mtu: u16,
    #[serde(rename = "systemProxy", skip_serializing)]
    pub legacy_system_proxy: Option<bool>,
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            capture_mode: "systemProxy".into(),
            tun_ipv6: true,
            tun_bypass_lan: true,
            tun_mtu: 1500,
            legacy_system_proxy: None,
